...
<body class="hold-transition login-page" style=" background-color: #bd6f47;">
  ...
  <div class="login-box">
    ...
    font-size: 24px; font-family: cursive;"> <strong>Lindero Grill</strong></h1>
        <p class="login-box-msg">Punto De Venta-<strong>PDVLG</strong> </p>
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            <input type="text" id="usu_usu" name="usu_usu" class="form-control" placeholder="Ingrese su usuario">
        ...
        .btn:hover{
          ...
          <button type="submit" class="btn btn-info btn-block" style=" background-color: #ff5600; border: 1px solid #ff5600;">Ingresar</button>
          <!-- /.social-auth-links -->
        </form>
